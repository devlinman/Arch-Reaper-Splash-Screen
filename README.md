...
+ This is my personal splash screen I use, and nothing more.


+ This is a fork/derivative of previous versions of this splash screen
+ More information can be found in [metadata.json file](./metadata.json).
